...
function SellerRegister() {
  ...
  const { seller, loading, getSellerData } = useContext(SellerAuthContext);
  ...
  const submitHandler = event => {
    ...
    axios
      .post(`/api/seller/sellerRegister`, body)
      .then(res => {
  ...
  return (
    <>
      <SellerNavbar />
      <div className=' sm:h-screen h-full bg-gradient-to-tl from-green-400 to-indigo-900 w-full py-11 px-4'>
        <div className='flex flex-col items-center justify-center'>
          <div className='bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16'>
            ...
            <p className='text-sm mt-4 font-medium leading-none text-gray-500'>
              ...
              >
                {' '}
                <Link href='/sellersignin'> Login here</Link>
              </span>
            </p>
            <button
